...
public class TeacherDaoImpl extends AbstractCrudDaoImpl<Teacher> implements TeacherDao {
    ...
    protected TeacherDaoImpl(SessionFactory sessionFactory) {
        super(sessionFactory, FIND_ALL_QUERY, TEACHER_CLASS);
    }
    ...
    public List<Teacher> findByCourse(String courseName) {
        ...
        return session.createQuery(FIND_BY_COURSE_QUERY, TEACHER_CLASS)
    ...
    public void addToCourse(UUID id, String courseName) {
        ...
        Teacher teacher = session.get(TEACHER_CLASS, id);
        Course course = session.createQuery(FIND_COURSE_TO_ADD_TEACHER_QUERY, COURSE_CLASS)
            .setParameter(COURSE_NAME_PARAMETER, courseName)
            .getSingleResult();
    ...
    public Optional<Teacher> findByEmail(String email) {
        ...
        Teacher teacher = session.createQuery(FIND_BY_EMAIL_QUERY, TEACHER_CLASS)
